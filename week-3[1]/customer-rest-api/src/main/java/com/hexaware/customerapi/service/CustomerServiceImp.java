...
public class CustomerServiceImp implements ICustomerService {
	...
	public CustomerProductVO getCustomerAndProductById(int customerId) {
		CustomerDTO customerDTO=getCustomerId(customerId);
		int pid=customerDTO.getProductId();
		ProductDTO productDTO=restTemplate.getForObject("http://localhost:8181/api/products/get/"+pid,ProductDTO.class);
